...
type
  TDm = class(TDataModule)
    ...
    fdsettings: TFDQuery;
    fdsettingsid: TFDAutoIncField;
    fdsettingssetting_name: TStringField;
    fdsettingssetting_boolean: TBooleanField;
    fdsettingssetting_value: TStringField;
    RlConnection: TFDConnection;
    CylindersTable: TFDQuery;
    CylindersTableid: TFDAutoIncField;
    CylindersTableteeth: TIntegerField;
    CylindersTablecircumference_mm: TBCDField;
    CylindersTablecircumference_inch: TBCDField;
    CylindersTablemachine1: TBooleanField;
    CylindersTablemachine2: TBooleanField;
    CylindersTablecreated_at: TSQLTimeStampField;
    CylindersTableupdated_at: TSQLTimeStampField;
